...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_SPC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_NUBS, KC_NUHS, \
  KC_F17,  KC_LALT, KC_LCTL, KC_TAB,  KC_LGUI, LOWER,      RAISE,   KC_ENT,  KC_MINS, KC_QUOT, KC_DQUO, KC_F18   \
),
